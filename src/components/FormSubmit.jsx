...
const FormSubmit = ({ inputQuery }) => {
    ...
    const fetchExpenses = async () => {
        ...
        try {
            ...
            const response = await axios.get('https://expense-manager-nmegzi8kc-suketu-vaniyas-projects.vercel.app/api/v1/manager/get-expenses', {
    ...
    const updateExpenseHandler = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://expense-manager-nmegzi8kc-suketu-vaniyas-projects.vercel.app/api/v1/manager/update-expense/${editExpense._id}`,
                {
    ...
    const addExpense = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                'https://expense-manager-nmegzi8kc-suketu-vaniyas-projects.vercel.app/api/v1/manager/add-expense',
                newExpense,
                { headers: { 'Authorization': `Bearer ${token}` } }
            );
            ...
            const response1 = await axios.get('https://expense-manager-nmegzi8kc-suketu-vaniyas-projects.vercel.app/api/v1/manager/get-expenses', {
                headers: { 'Authorization': `Bearer ${token}` },
            });
    ...
    const deleteExpense = async (id) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`https://expense-manager-nmegzi8kc-suketu-vaniyas-projects.vercel.app/api/v1/manager/delete-expense/${id}`, {
                headers: { 'Authorization': `Bearer ${token}` },
            });
